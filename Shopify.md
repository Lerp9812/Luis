...
3. En la sección **Formas de pago admitidas**, haz clic en el botón **Agregar formas de pago**.
4. En el campo **Buscar por formas de pago** escribe `Kueski`. <br>
Te saldrá la opción de Kueski Pay.
5. Haz clic en Kueski Pay.
...
7. Haz clic en el botón **Conectar**.
...
8. Cierra la página del formulario.
9. Notifica a Kueski mediante un correo, que el formulario ya se completó. 
10. Espera el correo por parte de Kueski notificando que el comercio se encuentra activo en la plataforma de Kueski.
...
11. Haz clic en el botón **Activar Kueski Pay: Compra sin tarjeta**. <br>
...
2. En el menú del lado izquierdo, sigue el siguiente flujo **Canales de venta** -> **Tienda online** -> **Temas**.
3. Haz clic en el botón **Acciones**. <br>
...
5. En la columna de archivos, haz clic en la carpeta **Snippets**.
6. Haz clic en **Agregar un nuevo snippet**. <br>
...
7. En el campo **Crea un nuevo fragmento de código llamado** escribe `kp-product-page-snippet`.
8. Haz clic en el botón **Crear fragmento de código**. <br>
...
> :warning: :heavy_exclamation_mark: **IMPORTANTE:**  
> Reemplaza el texto **API-KEY** por la llave _Public API Key_ proporcionada por el equipo de Kueski.
...
10. Haz clic en el botón **Guardar**. <br>
Saldrá un mensaje con el texto _Asset saved_.
11. En la columna de archivos haz clic en la carpeta **Sections**. 
12. Abre el archivo **main-product.liquid**.

> :warning: :heavy_exclamation_mark: **IMPORTANTE:**  
> En caso de no encontrar tal archivo, trata con los siguientes: **main-product-footer.liquid** o **product-template.liquid**.<br>
En caso de no existir ninguno de los archivos antes mencionados, contacta directamente a Kueski. 

12. Identifica en el código el siguiente fragmento:<br>
...
13. Posiciona el cursor al inicio del código del paso anterior. 
...
15. En la línea en blanco, copia el siguiente fragmento de código: <br>
...
16. Haz clic en el botón **Guardar**.
...
3. En el campo **Crea un nuevo fragmento de código llamado** escribe `kp-cart-page-snippet`
4. Haz clic en el botón **Crear fragmento de código**. <br>
...
6. Haz clic en el botón **Guardar**. <br>
Saldrá un mensaje de texto diciendo _Asset saved_.
7. En la carpeta **Sections** busca el archivo **main-cart-footer.liquid**
8. Identifica en el código el siguiente fragmento: `<small class="tax-note caption-large rte">`
...
9. Posiciona el cursor al inicio del código del paso anterior.
...
11. En la línea en blanco, copia el siguiente fragmento de código: `{% include 'kp-cart-page-snippet' %}`
